...
namespace ExcelApp.Helpers
{
    public static class Helpers
    {
        public static async Task<string> SaveAsExcel(DataTable jsonDt, string fileName)
        {
            using (var workbook = new XLWorkbook())
            {
                try
                {
                    ...
                    var worksheet = workbook.Worksheets.Add(jsonDt, "UpdatedData");
                    workbook.SaveAs($"D:\\ResourceData\\Result\\{fileName}.xlsx");
                    return fileName;
                }
                catch (Exception ex)
                {
        ...
        public static async Task<ResourcesBaseDto> ReadJsonFile(string fileAddress)
        {
            try
            {
        ...
        public static List<ResourcesDto> ConvertExcelToDataSet(string fileName)
        {
            try
            {
                Encoding.RegisterProvider(CodePagesEncodingProvider.Instance);
